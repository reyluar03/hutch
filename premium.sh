...
dbhost='185.2.168.30';
dbuser='solidvpn_hutch';
dbpass='zuma@1234';
dbname='solidvpn_hutch';
dbport='3306';
clear
dt=$(date '+%d/%m/%Y %H:%M:%S');
echo "$dt"
...
$DB_user = "solidvpn_hutch";
$DB_pass = "zuma@1234";
$DB_name = "solidvpn_hutch";
$DB_port = "3306";
...
clear
#get active.txt 
wget https://raw.githubusercontent.com/reyluar03/hutch/master/ssh/vipactive.sh
wget https://raw.githubusercontent.com/reyluar03/hutch/master/ssh/vipnotactive.sh
